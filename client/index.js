...
var _user$project$Components$task = F2(
	function (service, _p0) {
		...
		var classes = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _p5.state, _1: true},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Basics_ops['++'], 'desired-', _p4),
					_1: true
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'running-old',
						_1: _elm_lang$core$Native_Utils.eq(_p5.state, 'running') && (!_elm_lang$core$Native_Utils.eq(service.containerSpec.image, _p1.containerSpec.image))
					},
					_1: {ctor: '[]'}
				}
			}
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_user$project$Components$statusString, _p5.state, _p4)),
								_1: {ctor: '[]'}
							}
						}
					}
